...
public class ventana41 extends JFrame implements ActionListener {
	...
	// deberá aparecer la imagen correspondiente
	...
	// Agrupamos los radio de forma lógica
	// es decir no ocupan un lugar dentro de la interfaz
	// porque no es un componente gráfico
	...
	public ventana41() {
		super("Tecnologías web");

		// No hace falta ponerlo ya que por defecto al frame
		// siempre se le asigna un BorderLayout por defecto
		// this.setLayout(new BorderLayout());

		// por defecto estará seleccionado el primer radio
		htmlButton.setSelected(true);

		// setIcon es un método que sirve para establecer imagenes en el label
		...
		// El ButtonGroup no se añade al panel porque su función es la de agrupar
		...
		// Por último, añadimos el panel en la parte izquierda
	...
	public void actionPerformed(ActionEvent evento) {
		// el método getSource nos devuelve el objeto responsable de la acción del
		// evento
		if (evento.getSource() == htmlButton) {
			// Objeto anónimo new ImageIcon("assets/html5.png")
			// porque su representación memoria no tiene un identificador como por ejemplo
			// sí lo tiene al principio del programa ImageIcon imagen = new
			// ImageIcon("ruta/imagen.png");
			// de tal forma que podemos usar el identificador imagen para operar con él en
